...
7) Go to config/settings.js and fix all of the TODOs.
8) Go to routes/routes.js, update the application name, and add a new route for the endpoint you would like to add.
9) To operate the new endpoint, you will need to implement an endpoint controller. Controllers live in the lib directory.
