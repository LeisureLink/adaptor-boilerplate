...
6) Go to settings/config.js and fix all of the TODOs.
7) Go to routes.js, update the application name, and add a new route for the endpoint you would like to add.
8) To operate the new endpoint, you will need to implement an endpoint controller. Controllers live in the endpoints directory.
